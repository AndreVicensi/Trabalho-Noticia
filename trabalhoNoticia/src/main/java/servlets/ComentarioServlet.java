...
public class ComentarioServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// request.getRequestDispatcher("/comentar/listar.jsp");
		...
		// RequestDispatcher dispatcher =
		// request.getRequestDispatcher("/noticia/listar.jsp");
		// dispatcher.forward(request, response);
		// }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		noticiadb.inserirComentario(noticia, comentarioNovo);

		RequestDispatcher dispatcher = request
				.getRequestDispatcher("/NoticiaServlet?opcao=carregar&codigo=" + codNoticia);
